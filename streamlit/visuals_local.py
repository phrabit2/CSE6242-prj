...
# ══════════════════════════════════════════════════════════════════════════════
# PAGE 4 — Change Forest
# ══════════════════════════════════════════════════════════════════════════════
elif "Change" in page:
    st.markdown("# Change Forest?")
    st.markdown("""<div class="preamble">
    The <b>Change Forest</b> identifies change points in a player's performance index time series, flagging when a significant shift has occurred.
    Models are pre-trained offline and loaded from Google Drive — no in-app training.
    </div>""", unsafe_allow_html=True)
